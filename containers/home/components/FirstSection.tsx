...
export default function FirstSection() {
  ...
  return (
    <section className="section_style w-full flex flex-col justify-center gap-y-8">
      ...
      <article className="flex flex-col gap-y-2 items-center text-justify">
        <p>
          Bienvenido/a a nuestra página web, un espacio diseñado para ofrecerte
          la mejor información y servicios de calidad. Nos enorgullece brindarte
          contenido relevante, actualizado y adaptado a tus necesidades. Aquí
          encontrarás una gran variedad de recursos para explorar y aprovechar.
        </p>

        <p>
          En un mundo en constante evolución, es fundamental contar con
          información precisa y accesible. Nuestro equipo trabaja día a día para
          garantizar que cada artículo, guía y recomendación que publicamos sea
          útil y confiable. Creemos que el conocimiento es una herramienta
          poderosa y queremos que formes parte de esta comunidad de aprendizaje.
        </p>
        ...
        <p>
          ...
          encontrar lo que buscas de manera rápida y eficiente. Ya sea que estés
          aquí por curiosidad, necesidad o interés profesional, queremos que
          disfrutes del contenido sin complicaciones.
        </p>
        ...
        <p>
          ...
          interactivas para mejorar tu experiencia. Encuestas, foros y secciones
          de comentarios están disponibles para que puedas participar
          activamente y compartir tus opiniones. Creemos en la importancia de la
          comunidad y en el intercambio de ideas para generar un impacto
          positivo.
        </p>
        ...
        <p>
          ...
          encuentres en nuestro sitio un lugar útil, interesante y enriquecedor.
          ¡Bienvenido/a y disfruta de la experiencia!
        </p>
      </article>
